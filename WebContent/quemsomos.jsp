	...
	<div id="caixaJogo" class="col-dg-12 ">
		...
		<div class="col-dg-8 cor conteudo">
			<div>
				...
				<p></p>
				<p>
					O "nome do jogo/site" é um projeto constituído por <b>Ariel
						Vieira</b>, <b>Eduardo Rodrigues</b>, <b>Flavio Santos</b>, <b>Gustavo
						Henrique</b>, e por <b>Rooney Petras</b>
				</p>
				<p>O projeto consiste no desenvolvimento de uma aplicação web
					com a finalidade de aplicar e melhorar os conhecimentos que os
					alunos estão aprendendo no curso de Sistemas para Internet no IFTM</p>
			</div>
		</div>
