            ...
            <div class="col-dg-8 cor conteudo">
                <div>
                    <h2>COMO JOGAR</h1>
                        ...
                        <p>Aqui fizemos uma portabilidade para um multiplayer de dois jogadores que vivem o papel do detetive ou de um criminoso culpado por um roubo.</p>
                        <p>Você precisa fazer as perguntas corretas para as pessoas corretas para descobrir quem é o meliante, lembrando que um dos inocentes poderá está sendo manipulado para tentar te enganar.</p>
                        <p>Conseguirá o detetive capturar o meliante? Conseguirá o meliante fugir ileso?</p>
                        <p>Entre com seus amigos nesse intrigante jogo mental de verdades e mentiras.</p>
                </div>
            </div>
